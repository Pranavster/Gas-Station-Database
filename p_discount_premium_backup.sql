CREATE DEFINER=`root`@`127.0.0.1` PROCEDURE `p_discount_premium`(p_prod_id int, p_currmonth varchar(7),p_dp_type char(1),p_dp_perc decimal(2),p_applicable char(1), p_addby varchar(50), 
